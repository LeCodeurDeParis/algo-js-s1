...
let Ralpho = new Pokémon("Ralpho", 10, 4, 20, 90)
let Ybois = new Pokémon("Ybois", 8, 5, 25, 90)
/*
...
while (gameLoop == true){
    if (luckRandom() < Ralpho.luck){
        ...
        console.log("L'attaque à raté")
    }

    if (luckRandom() < Ybois.luck){
